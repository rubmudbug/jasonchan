...
<html>
	...
	<body>
		<div class='container'>
			...
			<form method="post" action="dealpic.php">
			<div class='head-dex'>
				...
				<?php
					...
					if($flag==0)
					{
						echo '<div class="main-img"><img name="manga-img" src="myimg/demo1.png"/></div>';
						$myfile = fopen("temporation.txt","r+");
						fwrite($myfile, '1');
						fclose($myfile);
					}
					else if(@$_POST['submit-ne']=='下一页')
					{
						...
						echo '<div class="main-img"><img name="manga-img" src="myimg/demo'.$string.'.png"/></div>';
						fclose($Myfile);
						$Myfile=fopen("imgsrc.txt","r+");
